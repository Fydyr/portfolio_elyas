    ...
    <div class="container main-content text-center py-5">
        <div class="card shadow-glow mx-auto" style="max-width: 500px;">
            <div class="card-body">
                ...
                <h1 class="glow-effect mb-3">418 - I'm a teapot</h1>
                <p class="lead mb-4">
                    Sorry, I can't brew coffee — I'm a teapot.<br>
                    <span class="badge bg-warning mt-2">HTTP error 418</span>
                </p>
